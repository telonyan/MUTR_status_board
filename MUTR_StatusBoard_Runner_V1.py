...
"""
Future Improvements:
    -Create a spreadsheet to record experimental data.
...
with open('MUTR_FuelElements_V4.csv', encoding='utf-8-sig') as FuelElement_Data:
...
with open('MUTR_CoreGeometry_V6.csv', encoding='utf-8-sig') as CoreGeometry_Data:
...
#Importing Control Widget Dimentions
Control_Dict = {}
...
class Create_Core_Canvas: #would like to update name    
    def Draw_Reactor(canvas,Module,Unit,X1,Y1,X2,Y2):
        if Module == "Fuel Bundle":
            ...
            #Once we have a location for the new fuel, this can be easaly generalized
